package es.hecnabae.pf.bean;

import es.hecnabae.pf.infra.model.Filter;
import es.hecnabae.pf.model.Car;
import es.hecnabae.pf.service.CarService;
...
import static es.hecnabae.pf.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                es.hecnabae.pf.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? es.hecnabae.pf.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? es.hecnabae.pf.infra.model.SortOrder.DESCENDING
                            : es.hecnabae.pf.infra.model.SortOrder.UNSORTED;
                }
